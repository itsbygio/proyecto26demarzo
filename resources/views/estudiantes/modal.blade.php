      ...
      <table id="table_modal" class="table table-striped table-bordered" style="width:100%">
        ...
        <tr>
            ...
            <div class="form-check form-check-inline ">
                <input class="form-check-input" onclick="RadioModalClick(this);" value="{{$curso->titulo}},{{$curso->id}}" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
            </div>
            </td>
